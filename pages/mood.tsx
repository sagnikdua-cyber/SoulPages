      ...
      <div className="max-w-5xl mx-auto space-y-16">
            ...
            {Array.from({ length: days }).map((_, i) => {
              ...
              return (
                <motion.div 
                  ...
                  className="aspect-square border-r border-b border-white/5 p-4 relative group cursor-pointer hover:bg-white/5 transition-all"
                >
                   <span className="text-sm font-black text-slate-700 group-hover:text-white transition-all uppercase tracking-widest pl-2">
                      {day}
                   </span>
                   {dominantMood && (
        ...
        <div className="flex flex-wrap justify-center gap-10 pt-10">
           {Object.keys(moodPalette).map((mood) => (
             <div key={mood} className="flex items-center gap-4 group">
                <div className={`w-8 h-8 rounded-xl ${moodPalette[mood as Mood]} border border-white/10 shadow-glow transition-transform group-hover:scale-110`} />
